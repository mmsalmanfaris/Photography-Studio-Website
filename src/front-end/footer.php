                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Indoor shoot</a>
                            </p>
                            <p>
                                <a href="#!" class="text-reset">Outdoor shoot</a>
                            </p>
                            <p>
                                <a href="#!" class="text-reset">Editing</a>
                            </p>
                            <p>
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p><i class="fas fa-home me-3"></i> Maruthamunai, Sri Lanka</p>
                            <p>
                                <i class="fas fa-envelope me-3"></i>
                                info@mmsalmanfaris.com
                            </p>
